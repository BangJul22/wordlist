...
def detail(keyword):
    api_key = "3847d17b-56a4-485b-a292-f401f1d9e8a8"
...
@app.route('/error')
def error():
    msg = request.args.get('msg', 'coba kata lain')
    suggested_words = None

    if 'kamu ingi kata lain' in msg:
        suggested_words = msg.split('apakah kamu ingi')[-1].strip('?').split(',')
